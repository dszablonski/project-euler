 ...
 *
 *
 * TODO:    1) Make function which splits up a string into an integar matrix
 *              - Should remove redundant 0s
 *              - Should split rows into by new linie
 *              - Should split items by a space
 *
 *          2) Make a function which splits up a matrix into a number of minor matrices.
 *
 *
 *
 */
...
"20 73 35 29 78 31 90 01 74 31 49 71 48 86 81 16 23 57 05 54",
"01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48"};
struct minor { int min[4][4]; };
string majorArr[20][20];
...
void getMinors(string mat[20][20])
{
    minor myMinor;
